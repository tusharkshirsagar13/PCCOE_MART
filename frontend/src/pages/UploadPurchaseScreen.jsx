...
export default function UploadPurchaseScreen() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.oldPrice.trim() || isNaN(formData.oldPrice))
      return toast.error("Old Price must be a valid number");
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">
                    Help fellow students find great deals
                  </p>
                </div>
              </div>
              <button
          ...
          <div className="max-w-2xl mx-auto">
            ...
            <div className="mt-6 p-4 bg-white/80 backdrop-blur-sm border border-violet-200/50 rounded-xl shadow-lg">
              <div className="text-center">
                ...
                <p className="text-sm text-gray-600">
                  Turn your unused items into cash while helping fellow students
